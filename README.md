...
#### It's the part of HTTPP, that's for HTTP over UDP and bring Web in Peer or P2P style against client/central-server.
...
* Multipath routing naturally, Mobile internet friendly
